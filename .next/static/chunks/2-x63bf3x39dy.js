(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,37881,26726,573,31967,21449,e=>{"use strict";var t=e.i(71645);let i=`#version 300 es
...
}`;function n(e){if(e.naturalWidth<1024&&e.naturalHeight<1024){if(e.naturalWidth<1||e.naturalHeight<1)return;let t=e.naturalWidth/e.naturalHeight;e.width=Math.round(t>1?1024*t:1024),e.height=Math.round(t>1?1024:1024/t)}}e.s(["ShaderMount",0,o,"isPaperShaderElement",0,function(e){return"paperShaderMount"in e}],26726);var A=e.i(43476);async function l(e){let t={},i=[];return Object.entries(e).forEach(([e,r])=>{if("string"==typeof r){let o=r||"data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";if(!(e=>{try{if(e.startsWith("/"))return!0;return new URL(e),!0}catch{return!1}})(o))return void console.warn(`Uniform "${e}" has invalid URL "${o}". Skipping image loading.`);let s=new Promise((i,r)=>{let s=new Image;(e=>{try{if(e.startsWith("/"))return!1;return new URL(e,window.location.origin).origin!==window.location.origin}catch{return!1}})(o)&&(s.crossOrigin="anonymous"),s.onload=()=>{n(s),t[e]=s,i()},s.onerror=()=>{console.error(`Could not set uniforms. Failed to load image at ${o}`),r()},s.src=o});i.push(s)}else r instanceof HTMLImageElement&&n(r),t[e]=r}),await Promise.all(i),t}let h=(0,t.forwardRef)(function({fragmentShader:e,uniforms:i,webGlContextAttributes:r,speed:s=0,frame:a=0,width:n,height:h,minPixelRatio:c,maxPixelCount:u,mipmaps:g,style:f,...p},m){var d;let B,x,[E,w]=(0,t.useState)(!1),v=(0,t.useRef)(null),Q=(0,t.useRef)(null),S=(0,t.useRef)(r);(0,t.useEffect)(()=>((async()=>{let t=await l(i);v.current&&!Q.current&&(Q.current=new o(v.current,e,t,S.current,s,a,c,u,g),w(!0))})(),()=>{Q.current?.dispose(),Q.current=null}),[e]),(0,t.useEffect)(()=>{let e=!1;return(async()=>{let t=await l(i);e||Q.current?.setUniforms(t)})(),()=>{e=!0}},[i,E]),(0,t.useEffect)(()=>{Q.current?.setSpeed(s)},[s,E]),(0,t.useEffect)(()=>{Q.current?.setMaxPixelCount(u)},[u,E]),(0,t.useEffect)(()=>{Q.current?.setMinPixelRatio(c)},[c,E]),(0,t.useEffect)(()=>{Q.current?.setFrame(a)},[a,E]);let C=(d=[v,m],B=t.useRef(void 0),x=t.useCallback(e=>{let t=d.map(t=>{if(null!=t){if("function"==typeof t){let i=t(e);return"function"==typeof i?i:()=>{t(null)}}return t.current=e,()=>{t.current=null}}});return()=>{t.forEach(e=>e?.())}},d),t.useMemo(()=>d.every(e=>null==e)?null:e=>{B.current&&(B.current(),B.current=void 0),null!=e&&(B.current=x(e))},d));return(0,A.jsx)("div",{ref:C,style:void 0!==n||void 0!==h?{width:"string"==typeof n&&!1===isNaN(+n)?+n:n,height:"string"==typeof h&&!1===isNaN(+h)?+h:h,...f}:f,...p})});h.displayName="ShaderMount",e.s(["ShaderMount",0,h],37881),e.s(["colorPropsAreEqual",0,function(e,t){for(let i in e){if("colors"===i){let i=Array.isArray(e.colors),r=Array.isArray(t.colors);if(!i||!r){if(!1===Object.is(e.colors,t.colors))return!1;continue}if(e.colors?.length!==t.colors?.length||!e.colors?.every((e,i)=>e===t.colors?.[i]))return!1;continue}if(!1===Object.is(e[i],t[i]))return!1}return!0}],573),e.s(["ShaderFitOptions",0,{none:0,contain:1,cover:2},"defaultObjectSizing",0,{fit:"contain",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},"defaultPatternSizing",0,{fit:"none",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0}],31967);let c=(e,t,i)=>Math.min(Math.max(e,t),i),u=[0,0,0,1];e.s(["getShaderColorFromString",0,function(e){if(Array.isArray(e))return 4===e.length?e:3===e.length?[...e,1]:u;if("string"!=typeof e)return u;let t,i,r,o=1;if(e.startsWith("#")){var s;[t,i,r,o]=(3===(s=(s=e).replace(/^#/,"")).length&&(s=s.split("").map(e=>e+e).join("")),6===s.length&&(s+="ff"),[parseInt(s.slice(0,2),16)/255,parseInt(s.slice(2,4),16)/255,parseInt(s.slice(4,6),16)/255,parseInt(s.slice(6,8),16)/255])}else if(e.startsWith("rgb")){let s;[t,i,r,o]=(s=e.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(s[1]??"0")/255,parseInt(s[2]??"0")/255,parseInt(s[3]??"0")/255,void 0===s[4]?1:parseFloat(s[4])]:[0,0,0,1]}else{let s;if(!e.startsWith("hsl"))return console.error("Unsupported color format",e),u;[t,i,r,o]=function(e){let t,i,r,[o,s,a,n]=e,A=o/360,l=s/100,h=a/100;if(0===s)t=i=r=h;else{let e=(e,t,i)=>(i<0&&(i+=1),i>1&&(i-=1),i<1/6)?e+(t-e)*6*i:i<.5?t:i<2/3?e+(t-e)*(2/3-i)*6:e,o=h<.5?h*(1+l):h+l-h*l,s=2*h-o;t=e(s,o,A+1/3),i=e(s,o,A),r=e(s,o,A-1/3)}return[t,i,r,n]}((s=e.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(s[1]??"0"),parseInt(s[2]??"0"),parseInt(s[3]??"0"),void 0===s[4]?1:parseFloat(s[4])]:[0,0,0,1])}return[c(t,0,1),c(i,0,1),c(r,0,1),c(o,0,1)]}],21449)},93344,e=>{"use strict";let t=`
...
`,h={checks:0,stripes:1,edge:2};e.s(["WarpPatterns",0,h,"warpFragmentShader",0,l,"warpMeta",0,A],56318);var c=e.i(43476);let u={name:"Default",params:{...o.defaultPatternSizing,rotation:0,speed:1,frame:0,colors:["#121212","#9470ff","#121212","#8838ff"],proportion:.45,softness:1,distortion:.25,swirl:.8,swirlIterations:10,shapeScale:.1,shape:"checks"}},g=[u,{name:"Cauldron Pot",params:{...o.defaultPatternSizing,scale:.9,rotation:160,speed:10,frame:0,colors:["#a7e58b","#324472","#0a180d"],proportion:.64,softness:1.5,distortion:.2,swirl:.86,swirlIterations:7,shapeScale:.6,shape:"edge"}},{name:"Live Ink",params:{...o.defaultPatternSizing,scale:1.2,rotation:44,offsetY:-.3,speed:2.5,frame:0,colors:["#111314","#9faeab","#f3fee7","#f3fee7"],proportion:.05,softness:0,distortion:.25,swirl:.8,swirlIterations:10,shapeScale:.28,shape:"checks"}},{name:"Kelp",params:{...o.defaultPatternSizing,scale:.8,rotation:50,speed:20,frame:0,colors:["#dbff8f","#404f3e","#091316"],proportion:.67,softness:0,distortion:0,swirl:.2,swirlIterations:3,shapeScale:1,shape:"stripes"}},{name:"Nectar",params:{...o.defaultPatternSizing,scale:2,offsetY:.6,rotation:0,speed:4.2,frame:0,colors:["#151310","#d3a86b","#f0edea"],proportion:.24,softness:1,distortion:.21,swirl:.57,swirlIterations:10,shapeScale:.75,shape:"edge"}},{name:"Passion",params:{...o.defaultPatternSizing,scale:2.5,rotation:1.35,speed:3,frame:0,colors:["#3b1515","#954751","#ffc085"],proportion:.5,softness:1,distortion:.09,swirl:.9,swirlIterations:6,shapeScale:.25,shape:"checks"}}],f=(0,t.memo)(function({speed:e=u.params.speed,frame:t=u.params.frame,colors:r=u.params.colors,proportion:n=u.params.proportion,softness:A=u.params.softness,distortion:g=u.params.distortion,swirl:f=u.params.swirl,swirlIterations:p=u.params.swirlIterations,shapeScale:m=u.params.shapeScale,shape:d=u.params.shape,fit:B=u.params.fit,scale:x=u.params.scale,rotation:E=u.params.rotation,originX:w=u.params.originX,originY:v=u.params.originY,offsetX:Q=u.params.offsetX,offsetY:S=u.params.offsetY,worldWidth:C=u.params.worldWidth,worldHeight:I=u.params.worldHeight,...R}){let U={u_colors:r.map(s.getShaderColorFromString),u_colorsCount:r.length,u_proportion:n,u_softness:A,u_distortion:g,u_swirl:f,u_swirlIterations:p,u_shapeScale:m,u_shape:h[d],u_noiseTexture:(0,a.getShaderNoiseTexture)(),u_scale:x,u_rotation:E,u_fit:o.ShaderFitOptions[B],u_offsetX:Q,u_offsetY:S,u_originX:w,u_originY:v,u_worldWidth:C,u_worldHeight:I};return(0,c.jsx)(i.ShaderMount,{...R,speed:e,frame:t,fragmentShader:l,uniforms:U})},r.colorPropsAreEqual);e.s(["Warp",0,f,"warpPresets",0,g],65614)}]);