  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center justify-between">
        <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-accent-ghost text-lg transition-transform duration-300 group-hover:scale-110 group-hover:bg-accent/20 group-hover:shadow-[0_0_15px_rgba(255,255,255,0.2)]">
          {category.icon}
        </span>
